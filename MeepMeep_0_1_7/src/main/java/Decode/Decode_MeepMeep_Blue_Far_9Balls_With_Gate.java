...
public class Decode_MeepMeep_Blue_Far_9Balls_With_Gate {
    ...
    public static void main(String[] args) {
        ...
        Action SmallTriangleToLock = drive.actionBuilder(new Pose2d(48, -12, Math.toRadians(-90)))
                .splineToConstantHeading(new Vector2d(0, -30),  Math.toRadians(-90), fastVel, normalAccel)
                .splineToConstantHeading(new Vector2d(0, -45),  Math.toRadians(-90),fastVel, normalAccel)
                .strafeToConstantHeading(new Vector2d(0, -50), slowVel, normalAccel)
                .build();

        Action DriveLockToFirstMark = drive.actionBuilder(new Pose2d(0,-50, Math.toRadians(-90)))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(0, -30),  Math.toRadians(-270), fastVel, normalAccel)
        ...
        Action DriveCollectGateBallsToShootingPosition = drive.actionBuilder(new Pose2d(60,-60,Math.toRadians(-30)))
                .strafeToLinearHeading(new Vector2d(48,-12), Math.toRadians(-90), slowVel, normalAccel)
                .build();

        Action DriveOutOfSmallTriangle = drive.actionBuilder(new Pose2d(48,-12,Math.toRadians(-90)))
                .strafeToConstantHeading(new Vector2d(36,-12), fastVel, normalAccel)
                .build();
        ...
        // -------------------------
                        SmallTriangleToLock,
                        new SleepAction(2.0),  // Hold Gate open timer
