      ...
      /*  control.TagCorrection();
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.localizer.getPose())
                        .strafeToLinearHeading(new Vector2d(drive.localizer.getPose().position.x + .5, drive.localizer.getPose().position.y - control.distanceCorrectionLR_HL), Math.toRadians(180))
                        .build());
*/
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.localizer.getPose())
                        .strafeToLinearHeading(new Vector2d(stackX-2,drive.localizer.getPose().position.y - control.distanceCorrectionLR_HL), Math.toRadians(180), slowDownVelocityConstraint, slowDownAccelerationConstraint)
                        .build()
        );
        ...
        if (control.autoPosition == 2) {
            BoardTraj2 = drive.actionBuilder(drive.localizer.getPose())
        ...
        if (control.autoPosition == 2) {
            ...
            //*****************************************************
                DriveBackToStack2 = drive.actionBuilder(drive.localizer.getPose())
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            .strafeToLinearHeading(new Vector2d(stackX, drive.localizer.getPose().position.y + control.distanceCorrectionLR_HL), Math.toRadians(180), slowDownVelocityConstraint, slowDownAccelerationConstraint)
                            .build()
            );
            drive.updatePoseEstimate();
            ...
            drive.updatePoseEstimate();
                ...
                BoardTraj3 = drive.actionBuilder(drive.localizer.getPose())
                        .strafeToLinearHeading(new Vector2d(-55, stackY), Math.toRadians(180),slowDownVelocityConstraint)
                        .strafeToLinearHeading(new Vector2d(-24,stackY), Math.toRadians(180),speedUpVelocityConstraint)
                        .strafeToLinearHeading(new Vector2d(-12,stackY), Math.toRadians(180),speedUpVelocityConstraint)
                        .strafeToLinearHeading(new Vector2d(12,stackY), Math.toRadians(180),speedUpVelocityConstraint)
    ...
    public void BlueBoardPurplePixelDecision() {
        if (control.autoPosition == 1) {
            ...
            FloorTraj = drive.actionBuilder(drive.localizer.getPose())
    ...
    public class HalfwayTrigger1 implements Action{
        public boolean run(@NonNull TelemetryPacket packet) {
            ...
            //drive.updatePoseEstimate();
            if (drive.localizer.getPose().position.x >= 12) {
                moveArm = true;
