...
public final class MecanumDrive_Gertrude {
    ...
    public MecanumDrive_Gertrude(HardwareMap hardwareMap, Pose2d pose) {
        ...
        //localizer = new ThreeDeadWheelLocalizer_Gertrude(hardwareMap, MecanumDrive.PARAMS.inPerTick, pose);
        localizer = new TwoDeadWheelLocalizer_Gertrude(hardwareMap, lazyImu.get(), MecanumDrive_Gertrude.PARAMS.inPerTick, pose);
