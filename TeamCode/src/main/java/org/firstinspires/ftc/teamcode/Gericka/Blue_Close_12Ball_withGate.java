...
@Autonomous(name = "BLUE Close 12 BALL WITH GATE", preselectTeleOp = "Gericka 1 Manual Control")
public class

Blue_Close_12Ball_withGate extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        theRobot.BlueCloseDriveLockToBigTriangle
                )
        );
        ...
        // -------------------------
        // BIG TRIANGLE -> FIRST MARK -> BIG TRIANGLE SHOOT
        // -------------------------

        Actions.runBlocking(
                new SequentialAction(
                        setIntakeOn(),
                        theRobot.BlueCloseDriveBigTriangleToFirstMark,
                        setIntakeOff(),
                        theRobot.BlueCloseDriveFirstMarkToPark
