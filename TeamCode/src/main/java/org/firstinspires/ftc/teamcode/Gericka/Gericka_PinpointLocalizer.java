...
@Config
public final class Gericka_PinpointLocalizer implements Localizer {
    ...
    public Gericka_PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
