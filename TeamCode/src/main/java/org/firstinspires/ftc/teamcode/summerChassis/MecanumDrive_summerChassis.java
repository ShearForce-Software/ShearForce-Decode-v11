...
public final class MecanumDrive_summerChassis {
    ...
    public MecanumDrive_summerChassis(HardwareMap hardwareMap, Pose2d pose) {
        ...
        localizer = new ThreeDeadWheelLocalizer_summerChassis(hardwareMap, MecanumDrive_summerChassis.PARAMS.inPerTick, pose);
        //localizer = new TwoDeadWheelLocalizer_summerChassis(hardwareMap, lazyImu.get(), MecanumDrive_summerChassis.PARAMS.inPerTick, pose);
