...
public class BlueFarWORLDS_Gertrude extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Actions.runBlocking(
            drive.actionBuilder(drive.localizer.getPose())
                .lineToX(drive.localizer.getPose().position.x-1.5)
                .build());
        ...
        // **********************************************************
        drive.updatePoseEstimate();
        DriveBackToStack = drive.actionBuilder(drive.localizer.getPose())
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.localizer.getPose())
                        .strafeToLinearHeading(new Vector2d(stackX-2,drive.localizer.getPose().position.y - control.distanceCorrectionLR_HL), Math.toRadians(180), slowDownVelocityConstraint)
                        .build()
        );
        drive.updatePoseEstimate();
