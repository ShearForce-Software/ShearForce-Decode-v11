...
public final class Gericka_MecanumDrive {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(Gericka_MecanumDrive.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(Gericka_MecanumDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(Gericka_MecanumDrive.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(Gericka_MecanumDrive.this.rightFront));
    ...
    public Gericka_MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
