...
// auto select manual opMode next
    @Autonomous(name = "BLUE FAR CLEANUP V3", preselectTeleOp = "Gericka 1 Manual Control")
public class

Blue_Far_Cleanup_V3 extends LinearOpMode {

    Gericka_Hardware theRobot = new Gericka_Hardware(
    ...
    public void runOpMode() {
        ...
        sleep(1500);
        theRobot.SetRoadrunnerInitialPosition(Gericka_Hardware.farBlueStartPose.position.x, Gericka_Hardware.farBlueStartPose.position.y, Gericka_Hardware.farBlueStartPose.heading.toDouble());
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        theRobot.BlueFarCleanUpDriveFirstMarkToShootingPosition
                )
        );
        drive.updatePoseEstimate();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        setIntakeOn(),
                        theRobot.BlueFarCleanUpDriveShootingPositionToCollectGateBalls2,
                        //new SleepAction(0.250),
                        setIntakeOff(),
                        theRobot.BlueFarCleanUpDriveCollectGateBallsToShootingPosition2
                )
        );
        drive.updatePoseEstimate();
