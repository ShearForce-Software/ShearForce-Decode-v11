...
@Config
public final class Gericka_ThreeDeadWheelLocalizer implements Localizer {
    ...
    public Gericka_ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
